...
create_clock -name rx_clk -period  16.276 [get_ports rx_clk_in]

# probably gone in 2016.4

create_clock -name clk_fpga_0 -period  20 [get_pins "i_system_wrapper/system_i/sys_ps7/inst/PS7_i/FCLKCLK[0]"]
create_clock -name clk_fpga_1 -period  25 [get_pins "i_system_wrapper/system_i/sys_ps7/inst/PS7_i/FCLKCLK[1]"]
create_clock -name clk_fpga_2 -period 100 [get_pins "i_system_wrapper/system_i/sys_ps7/inst/PS7_i/FCLKCLK[2]"]
...
set_input_jitter clk_fpga_2 3.0
